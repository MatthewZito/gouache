...
public class Constants {
  public static final String E_RESOURCE_UPDATE_FMT =
      "An exception occurred while updating the resource with id %s";

  public static final String E_RESOURCE_DELETE_FMT =
      "An exception occurred while deleting the resource with id %s";
  ...
  public static final String E_METHOD_NOT_ALLOWED_FMT =
      "The requested method %s at route %s is not supported.";

  public static final String E_INVALID_INPUT = "The provided input was not valid.";

  public static final String E_GENERIC =
      "An exception occurred and the requested operation could not be completed.";
