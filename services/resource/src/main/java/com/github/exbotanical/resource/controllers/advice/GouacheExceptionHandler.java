...
public class GouacheExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<GouacheResponseModel> gouacheExceptionHandler(GouacheException ex,
                                                                      WebRequest req) {
    // Derive the message data and build a GouacheResponse object.
    GouacheResponseModel ret = GouacheResponseModel.builder()
  ...
  public ResponseEntity<GouacheResponseModel> defaultExceptionHandler(
    Exception ex,
    ...
    if (ex instanceof HttpServerErrorException.InternalServerError) {
      return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(GouacheResponseModel.builder()
